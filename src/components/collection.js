      ...
      <div className="section large" style={{backgroundImage: 'url(https://i.pinimg.com/736x/1a/85/aa/1a85aac66c257cbb46fb716b300c0559.jpg)'}}>
        ...
        <footer>
          <div className="btn-group" role="group" aria-label="Basic link button group" style={{borderRadius:'100px'}}> 
            <Link to="/event" className="btn btn-outline-primary">Events</Link>
            <Link to="/" className="btn btn-outline-primary">Collections</Link>
          </div>
        </footer>
      </div>
...
<div className="section medium" style={{backgroundImage: 'url(https://c4.wallpaperflare.com/wallpaper/361/494/385/artwork-minimalism-black-background-simple-background-wallpaper-preview.jpg)'}}>
  <div className="inner-section" style={{display: 'flex', flexDirection: 'column-reverse'}}>
    <div className="d-flex flex-column bd-highlight mb-3">
      <div className="p-2 bd-highlight" style={{color:'white'}} ><h1>Explore your First Collectible</h1></div>
  ...
  <div className="row no-gutters">
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'9rem',height:'10rem'}}>
            <img src="https://www.searchenginejournal.com/wp-content/uploads/2023/04/the-metaverse-what-is-it-2-64412b87eaf6c-sej.png" className="card-img" alt="..."/>
        </div>
    </div>
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'15rem',height:'12rem'}}>
            <img src="https://assets.bizclikmedia.net/320/936356725b9d4aa5c02cec9f3dcb2b2c:9c8ae58487668c7fafa3c40a555796f8/gettyimages-1399581170.jpg" className="card-img" alt="..."/>
        </div>
    </div>
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'9rem',height:'10rem'}}>
            <img src="https://www.telefonica.com/en/wp-content/uploads/sites/5/2022/12/investing-in-metaverse.jpg?w=1200" className="card-img" alt="..."/>
        </div>
    </div>
</div>
      ...
      <div className="col">
      <button type="button" className="btn btn-warning" style={{borderRadius:'50px',width:'10rem'}}> <i className="fa-solid fa-hourglass-start"></i>  Join Waitlist</button>
      </div>
      </div>
      </div>
      </div>
