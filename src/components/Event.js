      ...
      <div className="section large" style={{backgroundImage: 'url(https://i.pinimg.com/736x/1a/85/aa/1a85aac66c257cbb46fb716b300c0559.jpg)'}}>
        ...
        <footer>
          <div className="btn-group" role="group" aria-label="Basic link button group" style={{borderRadius:'100px'}}> 
            <Link to="/" className="btn btn-outline-primary">Events</Link>
            <Link to="/collection" className="btn btn-outline-primary">Collections</Link>
          </div>
        </footer>
      </div>
...
<div className="section medium" style={{backgroundImage: 'url(https://c4.wallpaperflare.com/wallpaper/361/494/385/artwork-minimalism-black-background-simple-background-wallpaper-preview.jpg)'}}>
  <div className="inner-section" style={{display: 'flex', flexDirection: 'column-reverse'}}>
    <div className="d-flex flex-column bd-highlight mb-3">
      <div className="p-2 bd-highlight" style={{color:'white'}} ><h1>Explore your First Event</h1></div>
    
      <div className="p-2 bd-highlight" style={{color:'white'}}>
      <h1>Event Name</h1>
      <p><i className="fa-solid fa-location-dot" style={{marginRight:'10px'}}></i>  Venue       <i className="fa-solid fa-bell" style={{marginLeft:'10px'}}></i>      04/05/2024</p>
  ...
  <div className="row no-gutters">
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'9rem',height:'10rem'}}>
            <img src="https://theinfoera.com/wp-content/uploads/2022/07/HD-wallpaper-astronomical-astro-world-cactus-jack-travis-scott.jpg?x61812" className="card-img" alt="..."/>
        </div>
    </div>
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'15rem',height:'12rem'}}>
            <img src="https://www.conchovalleyhomepage.com/wp-content/uploads/sites/83/2023/04/gettyimages-1478868674-594x594-1.jpg?w=594" className="card-img" alt="..."/>
        </div>
    </div>
    <div className="col">
        <div className="card bg-dark text-white" style={{width:'9rem',height:'10rem'}}>
            <img src="https://e1.pxfuel.com/desktop-wallpaper/216/614/desktop-wallpaper-caktuz-gives-j-cole-drakes-hit-it-in-the-morning-new-meaning-j-cole.jpg" className="card-img" alt="..."/>
        </div>
    </div>
</div>
      ...
      <div className="col">
      <div className="card bg-dark text-white" style={{width:'9rem',height:'10rem'}}>
            <img src="https://developers.google.com/static/ml-kit/vision/barcode-scanning/images/qrcode.png" className="card-img" alt="..."/>
        </div>
        
      </div>
      <div className="col">
      <button type="button" className="btn btn-warning" style={{borderRadius:'100px'}}> <i className="fa-solid fa-hourglass-start"></i>  Join Waitlist</button>
      </div>
      </div>
      </div>
      </div>
